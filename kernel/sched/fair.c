 ...
 */
unsigned int sysctl_sched_latency			= 8000000;
EXPORT_SYMBOL_GPL(sysctl_sched_latency);
static unsigned int normalized_sysctl_sched_latency	= 8000000;
 ...
 */
unsigned int sysctl_sched_min_granularity			= 1000000;
EXPORT_SYMBOL_GPL(sysctl_sched_min_granularity);
static unsigned int normalized_sysctl_sched_min_granularity	= 1000000;
...
unsigned int sysctl_sched_wakeup_granularity			= 3000000;
static unsigned int normalized_sysctl_sched_wakeup_granularity	= 3000000;
...
uint __read_mostly sched_burst_cache_lifetime   = 150000000;
#endif // CONFIG_SCHED_BORE
